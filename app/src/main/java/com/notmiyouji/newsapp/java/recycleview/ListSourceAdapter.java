...
public class ListSourceAdapter extends RecyclerView.Adapter<ListSourceAdapter.ListSourceHolder> {
    ...
    public void onBindViewHolder(@NonNull ListSourceHolder holder, int position) {
        ...
        holder.source_name.setText(newsSource.getSourceName());
        holder.source_description.setText(newsSource.getSourceUrl());
        String path = newsSource.getImage();
        ...
        holder.detailsbtn.setOnClickListener(v -> {
            ...
            intent.putExtra("source_id", newsSource.getSourceId());
            intent.putExtra("source_name", newsSource.getSourceName());
            intent.putExtra("source_url", newsSource.getSourceUrl());
            intent.putExtra("source_description", newsSource.getInformation());
            intent.putExtra("source_image", newsSource.getImage());
